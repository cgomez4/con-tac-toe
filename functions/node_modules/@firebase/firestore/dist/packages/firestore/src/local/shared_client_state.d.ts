...
import { BatchId, MutationBatchState, OnlineState, TargetId } from '../core/types';
...
export declare class MutationMetadata {
    ...
    constructor(user: User, batchId: BatchId, state: MutationBatchState, error?: FirestoreError);
    /**
     * Parses a MutationMetadata from its JSON representation in LocalStorage.
     * Logs a warning and returns null if the format of the data is not valid.
     */
    static fromLocalStorageEntry(user: User, batchId: BatchId, value: string): MutationMetadata | null;
...
export declare class QueryTargetMetadata {
    ...
    readonly error: FirestoreError;
    constructor(targetId: TargetId, state: QueryTargetState, error?: FirestoreError);
    /**
     * Parses a QueryTargetMetadata from its JSON representation in LocalStorage.
     * Logs a warning and returns null if the format of the data is not valid.
     */
    static fromLocalStorageEntry(targetId: TargetId, value: string): QueryTargetMetadata | null;
    toLocalStorageJSON(): string;
}
/**
...
export declare class WebStorageSharedClientState implements SharedClientState {
    ...
    private handleLocalStorageEvent(event);
